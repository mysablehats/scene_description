...
class Cfer():
    def __init__(self):
        ...
        rospy.Subscriber(self.y_hat_topic, String, self.callback_yhat_update)
        rospy.Subscriber(self.y_topic, String, self.callback_y_update)
        rospy.Subscriber(self.done_topic, String, self.callback_done)
        rospy.Service('show_cf', std_srvs.srv.Empty,self.calccf)
        self.ylist = []
        self.yhatlist = []
        self.curry = None
        self.curry_hat = None
