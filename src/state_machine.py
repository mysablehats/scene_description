...
class statemachine():
    def __init__(self):
        ...
        try:
            ...
            # os.system("roslaunch scene_description cfer_ns.launch namespace:=split_setup")
            # os.system("roslaunch scene_description cfer_ns.launch namespace:=split_1")
            # os.system("roslaunch scene_description cfer_ns.launch namespace:=split_2")
            # os.system("roslaunch scene_description cfer_ns.launch namespace:=split_3")
            # os.system("roslaunch scene_description cfer_ns.launch namespace:=split_4")

            # subprocess.Popen(["roslaunch","scene_description","cfer_ns.launch","namespace:=split_2"])
            # subprocess.Popen(["roslaunch","scene_description","cfer_ns.launch","namespace:=split_3"])
            # subprocess.Popen(["roslaunch","scene_description","cfer_ns.launch","namespace:=split_4"])
            ...
            for i in range(1,5):
                ...
                thissubprocess = subprocess.Popen(["roslaunch","scene_description","cfer_ns.launch","namespace:=split_{}".format(i)])
